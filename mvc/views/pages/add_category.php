...
<!-- form thêm danh mục -->
  <form action="Category/<?= isset($category) ? "EditCategory/".$category["id"] : "AddCategory" ?>" method="POSt" >
    ...
    <div class="form-group">
      ...
      <input type="text" name="title" class="form-control" value='<?= isset($category) ? $category["title"] : "" ?>' id="exampleInputTitle" placeholder="Title">
    </div>
    <div class="form-group">
